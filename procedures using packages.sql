...
--ADD CUSTOMER TO THE TABLE USING PROCEDURE
...
EXECUTE BANK_PACK.PR_ADD_CUSTOMER('JAMES','S','MILLER','M','01-JUN-2018','IND');
SELECT * FROM BANK_CUST;


--ADD CUSTOMER CONTACT TO THE TABLE 
...
--TO ADD SB ACCOUNT TO THE TABLE

--step1 : ctreating package
...
EXECUTE BANK_PACK.PR_ADD_SB_ACCOUNT(1011,NULL,1000,'ACTIVE',SYSDATE,NULL);
...
EXECUTE BANK_PACK.PR_SB_DEPOSIT (1000012011,'Deposit',1000);
SELECT * FROM BANK_SB_ACCOUNT;
SELECT * FROM BANK_TRANSACTION;
